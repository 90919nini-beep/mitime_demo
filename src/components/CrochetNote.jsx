    ...
    <div className="font-sans w-full max-w-sm mx-auto">
      ...
      <div className="bg-white rounded-3xl shadow-[0_2px_20px_rgba(0,0,0,0.08)] overflow-hidden border border-gray-100">
        ...
        <div className="border-t border-gray-100 grid grid-cols-4 divide-x divide-gray-100">
          {/* Dashboard */}
          <button className="flex flex-col items-center gap-1 py-3 hover:bg-purple-50 transition-colors group">
            <svg width="22" height="22" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="3" y="3" width="17" height="17" rx="4.5" stroke="#7B8FD4" strokeWidth="2.8" fill="none"/>
              <rect x="24" y="3" width="17" height="17" rx="4.5" stroke="#7B8FD4" strokeWidth="2.8" fill="none"/>
              <rect x="3" y="24" width="17" height="17" rx="4.5" stroke="#7B8FD4" strokeWidth="2.8" fill="none"/>
              <rect x="24" y="24" width="17" height="17" rx="4.5" stroke="#7B8FD4" strokeWidth="2.8" fill="none"/>
              {/* bar chart in bottom-right square */}
              <rect x="27.5" y="35" width="3" height="4" rx="1.5" fill="#D4A843"/>
              <rect x="32"   y="32" width="3" height="7" rx="1.5" fill="#D4A843"/>
              <rect x="36.5" y="29" width="3" height="10" rx="1.5" fill="#D4A843"/>
            </svg>
            <span className="text-[10px] text-gray-400 group-hover:text-purple-500">Dashboard</span>
          </button>
          ...
          <button className="flex flex-col items-center gap-1 py-3 hover:bg-purple-50 transition-colors group">
            <svg width="22" height="22" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
              {/* folder body */}
              <path d="M4 14 Q4 10 8 10 L17 10 Q19 10 20 12 L22 14 L38 14 Q41 14 41 17 L41 36 Q41 40 37 40 L7 40 Q4 40 4 36 Z" stroke="#7B8FD4" strokeWidth="2.8" fill="none" strokeLinejoin="round"/>
              {/* sparkles */}
              <path d="M15 26 L15 20 M12 23 L18 23" stroke="#D4A843" strokeWidth="2.4" strokeLinecap="round"/>
              <path d="M15 20.5 L13.5 21.5" stroke="#D4A843" strokeWidth="1.8" strokeLinecap="round"/>
              <path d="M25 22 L25 18 M23 20 L27 20" stroke="#D4A843" strokeWidth="1.6" strokeLinecap="round"/>
              <path d="M30 32 L30 28 M28 30 L32 30" stroke="#D4A843" strokeWidth="1.6" strokeLinecap="round"/>
            </svg>
            <span className="text-[10px] text-gray-400 group-hover:text-purple-500">Project</span>
          </button>
          ...
          <button className="flex flex-col items-center gap-1 py-3 hover:bg-purple-50 transition-colors group">
            <svg width="22" height="22" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
              {/* 3 books */}
              <rect x="3"  y="8" width="11" height="30" rx="3" stroke="#7B8FD4" strokeWidth="2.8" fill="none"/>
              <rect x="17" y="8" width="11" height="30" rx="3" stroke="#7B8FD4" strokeWidth="2.8" fill="none"/>
              <rect x="31" y="8" width="11" height="30" rx="3" stroke="#7B8FD4" strokeWidth="2.8" fill="none"/>
              {/* bookmark on third book */}
              <path d="M35 8 L35 18 L38.5 15 L42 18 L42 8" fill="#D4A843"/>
            </svg>
            <span className="text-[10px] text-gray-400 group-hover:text-purple-500">Library</span>
          </button>

          {/* Add */}
          <button className="flex flex-col items-center gap-1 py-3 hover:bg-purple-50 transition-colors group">
            <svg width="22" height="22" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
              <circle cx="22" cy="22" r="20" fill="#7B8FD4"/>
              <path d="M22 12 L22 32 M12 22 L32 22" stroke="#D4A843" strokeWidth="4" strokeLinecap="round"/>
            </svg>
            <span className="text-[10px] text-gray-400 group-hover:text-purple-500">Add</span>
          </button>
        </div>
      </div>
    </div>
